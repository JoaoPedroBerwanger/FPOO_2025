...
import ticTacToe.gui.util.window.CellClickListener;
...
public class GameControl {
	...
	public GameControl(TableModel tableModel, ScoreModel scoreModel, VirtualPlayer virtualPlayer) 
	{
	...
	private void verifyWinnerAtSecoundDiagonal() 
	{
